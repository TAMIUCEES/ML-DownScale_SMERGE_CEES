# -*- coding: utf-8 -*-
"""auto_zonal_stats.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/173rfTHrH3QL_QCbsouZN-kgxoziKpTxx

# Introduction
The **auto_zonal_stats** program allows users to resample files, enabling raster file size conversion. The Auto Zonal Statistics program calculates statistics on raster values within zones of another dataset. The tool generates a raster output list, but it calculates only one statistic at a time.
