# -*- coding: utf-8 -*-
"""GBR_wout_verifier.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1O5VBkjT8uNy2eMvxz8fqV0WVC4b90TI9
...
> See the links below to more information on the packages:
...
- An example of the name of the variables list would be:
